"""
Django settings for thoughtWhispers project.
...
ROOT_URLCONF = 'thoughtWhispers.urls'
...
WSGI_APPLICATION = 'thoughtWhispers.wsgi.application'
...
EMAIL_BACKEND = 'thoughtWhispers.email_backend.CustomEmailBackend'
